<nav class="hidden text-gray-400  md:flex items-center justify-between text-xs">
        <ul class="flex uppercas font-semibold border-b-4 pb-3 space-x-10 ">
            ...
            <li><a wire:click.prevent="setStatus('Considering')" href="#" class="transition duration-150 ease-in 
                border-b-4 pb-3 hover:border-blue @if ($status === 'Considering') border-blue text-gray-900 @endif">Considering ({{ $statusCount['considering'] }})</a></li>
